//========================================================================
// slist-iobj-reverse-eval.c
//========================================================================
// This program evalutes the performance of SListIObj::reverse by running
...
{
  printf(
    "usage: ./slist-iobj-reverse-eval <size>\n\n"
    "Evaluation program for SListIObj::reverse\n\n"
